    ...
    "團體服系列": {
        ...
        "CP101 吸濕排汗團體服": {
            ...
            "pos_front": {
                ...
                "左胸 (Left Chest)": {"coords": (700, 400)},
                "右胸 (Right Chest)": {"coords": (480, 400)},
                "左臂 (Left Sleeve)": {"coords": (1120, 200), "default_rot": 55},
                "右臂 (Right Sleeve)": {"coords": (120, 200), "default_rot": -40},
            },

            "pos_back": {
                "背中置中 (Center)": {"coords": (530, 350)},
